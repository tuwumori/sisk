...
<div id="main_container">
    ...
    <div class="logo"><a href="#"><img src="images/logo.gif" alt="" title="" border="0" /></a></div>
         ...
         <form action="<?php echo base_url(); ?>index.php/login/check_login" method="post" class="niceform">
         
                <fieldset>
                    <dl>
                        <dt><label for="email">Username:</label></dt>
                        <dd>
						<?php echo form_input(array('name'=>'username', 'id'=>'username' ,'size'=>'54','type'=>'text', 'maxlength'=>'255')); ?>
						
                    </dl>
                    <dl>
                        <dt><label for="password">Password:</label></dt>
                        <dd>
						<?php echo form_input(array('name'=>'password', 'id'=>'password' ,'size'=>'54','type'=>'password', 'maxlength'=>'255')); ?>
