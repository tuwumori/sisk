	...
	<?php echo form_open('master_pertanyaan/add_process', 'class ="niceform"');?>						
				<a href="<?php echo base_url()?>index.php/master_pertanyaan">Kembali ke master pertanyaan</a>
                    ...
                    <dl>
                        ...
                        <?php $nama_pertanyaan = ''; if(set_value('nama_pertanyaan')!='') $nama_pertanyaan = set_value('nama_pertanyaan')?>
